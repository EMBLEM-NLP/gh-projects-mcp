...
export async function setWorkflowFilter(page, filterText = '') {
...
export async function readWorkflowVerification(page, repo, expectedFilter) {
...
async function withWorkflowsPage(owner, number, fn) {
  // Fail closed BEFORE attaching to Edge or importing Playwright when this
  // runtime cannot possibly use the browser-ui fallback (see
  // lib/runtime-capabilities.mjs) — e.g. any non-win32 container/hosted
  // environment such as a Codex sandbox or a remote Claude session.
