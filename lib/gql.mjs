 ...
 *
 * Project commands that have been migrated to direct GraphQL are handled by a
 * small API-compat module before falling through to the backend's generic gh
 * compatibility layer. This keeps the legacy MCP handlers stable while avoiding
 * one monolithic backend implementation.
 */
